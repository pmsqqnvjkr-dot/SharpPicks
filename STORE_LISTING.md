...
## Privacy Policy URL
https://app.sharppicks.ai/privacy

## Screenshots Needed (6-8)
1. Landing page hero — brand + tagline
2. Pick day card — showing analysis details
3. Pass day card — showing discipline in action
4. Performance dashboard — historical tracking
5. Multi-book odds comparison
6. Profile / subscription management
7. Push notification example (optional)
8. Insights / methodology page (optional)
