...
def market_view():
    ...
    for r in rows:
        ...
        game_data = {
            ...
            'spread_h1_home': r['spread_h1_home'] if sport == 'nba' else None,
            'spread_h1_away': r['spread_h1_away'] if sport == 'nba' else None,
            'total_h1': r['total_h1'] if sport == 'nba' else None,
