...
def send_welcome(to, first_name=None):
    ...
    <div style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 520px; margin: 0 auto; padding: 20px 24px 48px; color: #e0e0e0; background-color: #0A0D14;">
      <div style="text-align: center; margin-bottom: 24px;">
        <img src="{dashboard_url}/images/crest.png" alt="" width="32" height="32" style="display:inline-block;vertical-align:middle;margin-right:12px;" /><!--
        --><span style="font-family:Arial,Helvetica,sans-serif;font-size:14px;font-weight:800;letter-spacing:0.3em;text-transform:uppercase;color:#FFFFFF;vertical-align:middle;">SHARP<span style="opacity:0.5;margin:0 0.35em;font-weight:500;letter-spacing:0.15em;">||</span>PICKS</span>
      </div>
