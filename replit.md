...
- **Rest/rust penalty for favorites off long breaks:** `calculate_rust_penalty()` penalizes favorites with spread ≥ 8pts and rest ≥ 4 days by 1.5% edge (2.5% for ≥ 6 days rest). Evidence: 14,919-game backtest shows big favorites off 5+ days rest cover at 45.9% vs 48.7% baseline (-2.8pp). All-Star break big favorites: 42.4% ATS. Both live predictions and walk-forward validation apply the penalty. Constants: `RUST_REST_THRESHOLD=4`, `RUST_SPREAD_THRESHOLD=8`, `RUST_BASE_PENALTY_PCT=1.5`, `RUST_HEAVY_PENALTY_PCT=2.5`.
