...
## Recent Changes
- **2026-02-18**: Redesigned public Performance tab for clarity: Performance Snapshot (Record, ROI, Units Won, Equity Curve, Avg Edge), Selectivity panel with industry comparison, CLV panel (% beating close, avg CLV), Pick Timing log (released time, line at release, closing line, CLV per pick), Philosophy framework panel, Founding Members scarcity panel. Removed all technical jargon (sigma, shrinkage, elasticity, risk of ruin) from public view.
