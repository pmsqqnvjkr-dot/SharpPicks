...
## Recent Changes
- **2026-02-18**: Moved model metrics (Calibration, Edge Decay, Regime Detection, Kill Switch) from public Performance tab to admin-only Control Room in Command Center. Added `/api/admin/control-room` endpoint with 6 panels: Trigger States, Threshold Tuning, Bucket Segmentation, Decay Metrics, Fragility Scoring, Experimental Toggles.
